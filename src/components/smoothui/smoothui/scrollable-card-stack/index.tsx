          ...
          return (
            ...
            >
              ...
              >
                ...
                <div
                  className={cn(
                    "flex flex-col items-center justify-center gap-2 bg-background/95 p-5 text-center backdrop-blur-sm transition-colors duration-200"
                  )}
                >
                  <span className="font-bold text-foreground text-xl leading-tight">
                    {item.title}
                  </span>
                  <span className="font-normal text-foreground/70 text-sm md:text-base line-clamp-3 md:line-clamp-none max-w-sm">
                    {item.desc}
                  </span>
                </div>
              </div>
